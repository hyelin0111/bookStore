...
/**
 * Servlet implementation class CancelOldOrderListPageEnd
 */
@WebServlet("/order/cancelOldorderListPageEnd")
public class CancelOldOrderListPageEnd extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CancelOldOrderListPageEnd() {
        super();
...
//		System.out.println("memberNo="+memberNo+"\t "+startDate+"\t "+endDate+"\t "+"\t "+bookTitle);
		List<CancelOrder> list = new OrderService().selectCancelOldOrderByDate(memberNo, startDate, endDate, bookTitle, cPage, numPerPage);
...
//		int totalPage = (int) Math.ceil((double) totalBookCount / numPerPage);
		...
		int totalBookCount = new OrderService().selectCancelOldOrderByDateCount(memberNo, startDate, endDate, bookTitle);
		int totalPage = (int) Math.ceil((double) totalBookCount / numPerPage);
