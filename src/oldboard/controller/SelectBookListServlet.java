...
/**
 * Servlet implementation class SelectBookListServlet
 */
@WebServlet("/oldbook/selectBookListServlet")
public class SelectBookListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SelectBookListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Book> bookList = new BookService().selectBookList(cPage, numPerPage);
		
		int totalBookCount = new BookService().selectBookCount();
