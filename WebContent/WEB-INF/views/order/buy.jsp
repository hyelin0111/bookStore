...
<%
	...
	int orderQty = (int)request.getAttribute("orderQty");
...
<script>
   ...
   <table id="order_list2" class="order2">
      ...
      <tr>
         <td><img class="book2" src="<%=request.getContextPath()%>/images/<%=b.getBookNo()%>.jpg" alt="book_image" onerror="javascript:this.src='<%=request.getContextPath()%>/images/blank.png'"/></td>
         <td id="bookname2"><%=b.getBookTitle()%></td>
         <td class="float_right2"><%=b.getBookPrice()%>원</td>
         <td class="float_right2"><%=orderQty%></td>
         <td class="float_right2"><%=b.getBookPrice() * orderQty%>원</td>
      </tr>
   </table>
   상품 변경을 원하시면
   ...
   <table id="sum2" class="order2">
      ...
      <tr>
         <td>
            <span class="price2"><%=b.getBookPrice() * orderQty%></span><span class="won">원</span> 
         ...
         <td>
            <span class="price2 total2"><%=b.getBookPrice() * orderQty + 2500%></span><span class="won2 total2">원</span>
         </td>
      </tr>
   </table>
   <br />
...
<!--    <table id="abr_card_info2" class="order2 order_info2">
      ...
      <tr>
	   ...
	   <div id="order_btn_div2">
	   		...
	   		<input type="hidden" value="<%=orderQty%>" name="bookCnt"/>
