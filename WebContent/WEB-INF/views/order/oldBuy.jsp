...
<%@ page import="oldboard.model.vo.OldBoard, member.model.vo.*"%>
<%
...
<script>
   ...
   <table id="order_list2" class="order2">
      ...
      <tr>
         <td><img class="book2" src="<%=request.getContextPath()%>/images/<%=ob.getOldBookNo()%>.jpg" alt="book_image" onerror="javascript:this.src='<%=request.getContextPath()%>/images/blank.png'"/></td>
         <td id="bookname2"><%=ob.getBookTitle()%></td>
         <td class="float_right2"><%=ob.getOldBookPrice()%>원</td>
         <td class="float_right2"><%=ob.getOldBookCount()%></td>
         <td class="float_right2"><%=ob.getOldBookPrice() * ob.getOldBookCount()%>원</td>
      </tr>
   </table>
   상품 변경을 원하시면
   ...
   <table id="sum2" class="order2">
      ...
      <tr>
         <td>
            <span class="price2"><%=ob.getOldBookPrice() * ob.getOldBookCount()%></span><span class="won">원</span> 
         ...
         <td>
            <span class="price2 total2"><%=ob.getOldBookPrice() * ob.getOldBookCount() + 2500%></span><span class="won2 total2">원</span>
         </td>
      </tr>
   </table>
   <br />
         ...
         <td>
            ...
            <table id="info2">
               <tr>
                  <th>받으시는 분</th>
                  <td colspan="3">
                     <input type="text" name="userId" id="userId" title="받으시는분" style="width: 100px;"  required>
                     <!-- <span>(10자 내외 입력)</span> -->
                  </td>
               </tr>
               <tr>
...
<!--    <table id="abr_card_info2" class="order2 order_info2">
      ...
      <tr>
   	...
   	<form action="<%=request.getContextPath()%>/order/orderBookEnd" >
	   <div id="order_btn_div2">
	   		...
	   		<input type="hidden" value="<%=ob.getOldBookNo()%>" name="bookNo"/>
	   		<input type="hidden" value="<%=ob.getOldBookCount()%>" name="bookCnt"/>
