 ...
 * Generated at: 2018-05-13 06:07:06 UTC
...
public final class writeOldBoard_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/common/header.jsp", Long.valueOf(1526190423977L));
...
return;
 ...
 if(memberLoggedIn ==null){
      ...
      out.write("\t           <li id=\"jiseojae\"><a href=\"#\">지서재</a></li>\r\n");
...
if(memberLoggedIn != null && "admin".equals(memberLoggedIn.getMember_id())){ 
      ...
      out.write("}\r\n");
      out.write("\r\n");
      out.write("#searchOldBookDiv{\r\n");
      out.write("\tposition: absolute;\r\n");
      out.write("\tright: 480px;\r\n");
      ...
      out.write("\tvar imgCheck = $(\"#imgCheck\").val();\r\n");
      out.write("\tvar priceCheck = $(\"#oldBookPrice\").val();\r\n");
      out.write("\t\r\n");
      out.write("\tif( imgCheck != \"true\"){\r\n");
      out.write("\t\talert(\"책을 선택하세요\");\r\n");
      out.write("\t\treturn false;\r\n");
      out.write("\t}\r\n");
      out.write("\tif( priceCheck == 0){\r\n");
      out.write("\t\talert(\"가격을 정해주세요\");\r\n");
      out.write("\t\treturn false;\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\treturn true;\r\n");
      ...
      out.write("// 책검색\r\n");
      out.write(" $(document).ready(function(){\r\n");
      out.write("\t$(\"#searchOldBookDiv\").hide();\t\r\n");
      out.write("}); \r\n");
      out.write("\r\n");
      out.write("function fn_movePage(pageNo){\r\n");
      out.write("\tvar searchKeyword = $(\"#searchContent\").val();\r\n");
      out.write("\t\r\n");
      out.write("\tif( searchKeyword.trim().length != 0 ){\r\n");
      out.write("\t\t$.ajax({\r\n");
      out.write("\t\t\tdata : {\r\n");
      out.write("\t\t\t\t\t\tcPage : pageNo,\r\n");
      out.write("\t\t\t\t\t\tsearchKeyword : searchKeyword\r\n");
      out.write("\t\t\t\t\t},\r\n");
      out.write("\t\t\turl : \"");
      out.print(request.getContextPath());
      out.write("/oldbook/selectBookSearchListServlet\",\r\n");
      out.write("\t\t\ttype : \"get\",\r\n");
      out.write("\t\t\tdataType : \"html\",\r\n");
      out.write("\t\t\tsuccess : function(data){\r\n");
      out.write("\t\t\t\t$(\"#bookList\").html(data);\r\n");
      out.write("\t\t\t},\r\n");
      ...
      out.write("\telse{\r\n");
      out.write("\t\t$.ajax({\r\n");
      out.write("\t\t\tdata : { cPage : pageNo },\r\n");
      out.write("\t\t\turl : \"");
      out.print(request.getContextPath());
      out.write("/oldbook/selectBookListServlet\",\r\n");
      out.write("\t\t\ttype : \"get\",\r\n");
      out.write("\t\t\tdataType : \"html\",\r\n");
      out.write("\t\t\tsuccess : function(data){\r\n");
      out.write("\t\t\t\t$(\"#bookList\").html(data);\r\n");
      ...
      out.write("\t\t\r\n");
      out.write("\t\t$.ajax({\r\n");
      out.write("\t\t\tdata : { searchKeyword : searchKeyword },\r\n");
      out.write("\t\t\turl : \"");
      out.print(request.getContextPath());
      out.write("/oldbook/selectBookSearchListServlet\",\r\n");
      out.write("\t\t\ttype : \"get\",\r\n");
      ...
      out.write("\r\n");
      out.write("$(function(){\r\n");
      out.write("\t$(\"#searchBookBtn\").click(function(){\r\n");
      out.write("\t\t$(\"#searchOldBookDiv\").css(\"display\",\"block\");\r\n");
      out.write("\t});\r\n");
      out.write("});\r\n");
      out.write("\r\n");
      out.write("$(function(){\r\n");
      out.write("\t$(\"#cancelDivBtn\").click(function(){\r\n");
      out.write("\t\t$(\"#searchOldBookDiv\").hide();\r\n");
      out.write("\t\t$(\"#searchContent\").val(\"\");\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t$.ajax({\r\n");
      out.write("\t\t\turl : \"");
      out.print(request.getContextPath());
      ...
      out.write("\t<form action=\"");
      out.print(request.getContextPath());
      out.write("/oldboard/writeOldBoardEnd\" method=\"get\" >\r\n");
      out.write("\t\t<div id=\"searchOldBookDiv\">\r\n");
      out.write("\t\t\t<button type=\"button\" id=\"cancelDivBtn\">X</button>\r\n");
      out.write("\t\t\t<h2>도서 검색</h2>\r\n");
      out.write("\t\t\t도서명 : <input type=\"text\" id=\"searchContent\" value=\"\" placeholder=\"검색할 도서를 입력하세요.\" />\r\n");
      ...
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<th>등록할 도서</th>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t<button type=\"button\" id=\"searchBookBtn\">검색</button>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\t\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<th>도서 정보</th>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t<img src=\"\" id=\"insertOldBook\" />\r\n");
      out.write("\t\t\t\t\t<input type=\"hidden\" id=\"oldBookNo\" name=\"bookNo\" />\r\n");
      out.write("\t\t\t\t\t<input type=\"hidden\" id=\"imgCheck\" value=\"false\" />\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\t\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<th>가격</th>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t<input type=\"number\" name=\"price\"  id=\"oldBookPrice\" step=\"1000\" placeholder=\"1000단위로 입력하세요\"/>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\t\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<th colspan=\"2\">\r\n");
      out.write("\t\t\t\t\t<input type=\"submit\" value=\"등록하기\" onclick=\"return fn_validate();\" />\r\n");
      out.write("\t\t\t\t</th>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t</table>\r\n");
      out.write("\t</form>\r\n");
